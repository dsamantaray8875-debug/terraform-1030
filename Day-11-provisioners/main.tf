...
resource "aws_key_pair" "example" {
  key_name   = "task"
public_key = file("C:/Users/dsama/.ssh/id_ed25519.pub")
}
...
resource "aws_instance" "server" {
  ami                         = "ami-0fb110df4c5094d21" # Ubuntu AMI
...
#               EOF
  ...
  connection {
    ...
    private_key = file("C:/Users/dsama/.ssh/id_ed25519")          # Path to private key
...
resource "null_resource" "run_script" {
  provisioner "file" {
    connection {
      ...
      user        = "ubuntu"
      private_key = file("C:/Users/dsama/.ssh/id_ed25519")
    }
    source      = "dev.sh"
